...
\section{演習課題}
\label{sec-2-4}
\begin{frame}[label=sec-2-4-1]{課題2-1}
...
\begin{frame}[label=sec-2-4-2]{課題2-2}
...
\begin{frame}[label=sec-2-4-3]{課題2-3}
\end{frame}
...
\section{演習課題}
\label{sec-4-3}
\begin{block}{4-1 Bundlerで簡単なGemを作ってみる}
\begin{itemize}
