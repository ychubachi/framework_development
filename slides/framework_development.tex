...
\section{授業の方法}
\label{sec-1-3}
\begin{frame}[label=sec-1-3-1]{英語の原典を読む}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label=sec-1-3-5]{Memo}
\begin{itemize}
...
\section{演習課題}
\label{sec-1-4}
\begin{frame}[label=sec-1-4-1]{課題1-1}
\begin{block}{開発環境の構築}
\begin{itemize}
\item 演習用仮想化環境を用意する
\end{itemize}
...
\begin{frame}[fragile,label=sec-1-4-2]{課題1-2}
 \begin{block}{開発環境の構築}
\begin{itemize}
