...
\section{Rbenvの解説}
\label{sec-2-3}
\begin{frame}[label=sec-2-3-1]{Rbenvについて}
\begin{itemize}
...
\section{Bundlerの解説}
\label{sec-2-4}
\begin{frame}[label=sec-2-4-1]{Bundlerについて}
\begin{itemize}
...
\section{補足}
\label{sec-2-5}
\begin{frame}[label=sec-2-5-1]{MiniTest}
\begin{itemize}
...
\section{演習課題}
\label{sec-2-6}
\begin{frame}[label=sec-2-6-1]{課題2-1}
\begin{block}{RubyGems.orgにアカウントを作成}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label=sec-2-6-2]{課題2-2}
\begin{block}{ガイドを参考にGemを作る}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label=sec-2-6-3]{課題2-3}
\begin{block}{簡単なGemを作ってみる}
\begin{itemize}
\item 内容は簡単な計算を行うものとする
\begin{itemize}
